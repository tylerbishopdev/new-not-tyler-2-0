      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6 sm:py-9">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3">
              ...
              <motion.div className="relative w-full h-full" whileHover="hover">
                ...
                >
                  ...
                  <p className="mt-3 sm:mt-4 lg:mt-6 text-[12px] sm:text-[13px] lg:text-[13.5px] leading-[1.6] sm:leading-[21px] text-[#979797] max-w-[280px] sm:max-w-none">
                    Every project includes <span className="text-white">advanced neural networks</span>, powered by
                    state-of-the-art machine learning models.
                  </p>
                  <div className="mt-4 sm:mt-6 lg:mt-8 space-y-2">
                    {["Multi-modal processing", "Auto-scaling compute", "Custom model support"].map(
                      (feature, index) => (
                        <motion.div
                          key={feature}
          ...
          <div className="col-span-3">
            <Link
              href="/auth"
              className="group block h-[300px] sm:h-[350px] lg:h-[375px] relative overflow-hidden rounded-xl bg-[#1C1C1C] border border-[#2E2E2E] hover:border-cyan-500/50 transition-all duration-300 ease-in-out"
            >
              <motion.div
                className="relative z-10 p-5 sm:p-8 lg:p-10 h-full flex flex-col"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                whileHover="hover"
              >
                ...
                <p className="mt-3 sm:mt-4 lg:mt-6 text-[12px] sm:text-[13px] lg:text-[13.5px] leading-[1.6] sm:leading-[21px] text-[#979797]">
                  Train and fine-tune models with enterprise-grade security and data protection.
                </p>
                <div className="flex-grow flex items-center justify-center">
                  <motion.div
                    className="relative w-28 h-28 sm:w-32 sm:h-32 lg:w-40 lg:h-40"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.5 }}
                  >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 mt-3">
          ...
          <div className="col-span-1 lg:col-span-3 w-full">
            <Link
              href="/storage"
              className="group block h-[300px] sm:h-[350px] lg:h-[375px] relative overflow-hidden rounded-xl bg-[#1C1C1C] border border-[#2E2E2E] hover:border-cyan-500/50 transition-all duration-300 ease-in-out w-full"
            >
              <motion.div
                className="relative z-10 p-5 sm:p-8 lg:p-10 h-full flex flex-col"
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <p className="mt-3 sm:mt-4 lg:mt-6 text-[12px] sm:text-[13px] lg:text-[13.5px] leading-[1.6] sm:leading-[21px] text-[#979797]">
                  Version, store, and manage your AI models with enterprise-grade reliability.
                </p>
          ...
          <div className="col-span-3">
            <Link
              href="/realtime"
              className="group block h-[375px] relative overflow-hidden rounded-xl bg-[#1C1C1C] border border-[#2E2E2E] hover:border-cyan-500/50 transition-all duration-300 ease-in-out"
            >
              <motion.div
              ...
              >
                ...
                <p className="my-6 text-[13.5px] leading-[21px] text-[#979797]">
              ...
              >
                ...
                >
                  ...
                  <p className="bg-cyan-400 px-2 py-1  rounded-full mt-6 text-[13.5px] leading-[21px] text-[#979797]">
                    User 1
                  </p>
                </motion.div>
              </Cursor>
            ...
            >
              ...
              >
                ...
                <p className="mt-6 text-[13.5px] leading-[21px] text-[#979797]">
                  Leverage <span className="text-white">automated machine learning</span> to optimize model architecture
                  and hyperparameters.
                </p>
          ...
          <div className="col-span-3">
            ...
            >
              ...
              <motion.div
                className="absolute inset-x-10 bottom-10 space-y-2"
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.2 }}
              >
                {["/v1/predict", "/v1/train", "/v1/optimize"].map((endpoint, index) => (
                  ...
                  >
                    <div className="w-4 h-4 bg-[#2E2E2E] rounded-sm flex items-center justify-center">
                      <motion.div
                        className="w-2 h-2 bg-cyan-500 rounded-sm"
